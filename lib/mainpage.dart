                    ...
                    if (snapshot.hasData) {
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          Color favorite_color = fav[snapshot.data!.docs[index]
                                      ['productname'] +
                                  " " +
                                  snapshot.data!.docs[index]['productdesc']] ??
                              Colors.grey;
                          ////// SHARE
                          ...
                          void share(BuildContext context,
                            ...
                            final String text =
                                "${snapshot.data!.docs[index]['productname']} + ${snapshot.data!.docs[index]['productdesc']}";
                            Share.share(
                              text,
                                ...
                                onPressed: () async {
                                  await _firestore
                                    ...
                                    'productname': snapshot.data!.docs[index]
                                        ['productname'],
                                    'productdesc': snapshot.data!.docs[index]
                                        ['productdesc'],
                                ...
                                Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: (context) => product_details(
                                              ...
                                              productdesc: snapshot.data!
                                                  .docs[index]['productdesc'],
                                            )));
                              },
                  ...
                  child: MaterialButton(
                    ...
                    onPressed: () async {
                      if (productnameController.text == '' ||
                        ...
                        Reference ref =
                            storage.ref().child("test/" + imageId + ".jpeg");
            ...
            children: [
              ...
              StreamBuilder(
                ...
                builder: (BuildContext context,
                    AsyncSnapshot<QuerySnapshot> snapshot) {
                  gett() {
                    // to calculate total money spent by user
